...
const ALLOWED = /^\/3\/(search\/multi|trending\/all\/week|movie\/(popular|top_rated|now_playing|upcoming)|tv\/(popular|top_rated|on_the_air)|movie\/\d+(\/recommendations)?|tv\/\d+(\/season\/\d+|\/recommendations)?)$/
